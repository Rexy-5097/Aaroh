...
#
# Upstream AgentOS v1.0.0 hardcoded this to the framework author's local machine
# ("/Users/soumyadebtripathy/WorkFlow/agentos-template"), which made the validator
# report every file as missing on any other checkout. Resolved relative to this
# file instead, matching how tools/scripts/bootstrap_project.py already computes
# its root. Override with AGENTOS_ROOT if the layout ever differs.
