...
> **Layer:** Infrastructure | **Status:** Active â€” Completed in Phase 3
> **Purpose:** Measurable engineering targets â€” not subjective reviews.
> **Cross-refs:** `standards/README.md` Â· `checklists/README.md` Â· `workflows/master.md`
...
| [benchmarks.md](./benchmarks.md) | AI/ML & Research | Accuracy, precision, recall, F1, LLM evaluation (MMLU, GSM8K, RAG), statistical power, reproducibility | `ai-reviewer` Â· `science-reviewer` |
